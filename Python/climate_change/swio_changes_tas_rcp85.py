...
DIR='/Users/ctang/climate/CMIP5/monthly/tas/'
VARIABLE='tas'
PRODUCT='Amon'
ENSEMBLE='r1i1p1'
...
#plt.ylabel('Surface Downwelling Solar Radiation Change (W/m2)',fontsize=16)
plt.ylabel('Surface Temperature Changes ($^\circ$C)',fontsize=16)
plt.title("Surface Tempereture Changes over SA-SWIO simulated by CMIP5 models",fontsize=18)
