...
plt.ylabel('SWIO Surface Downwelling Radiation Changes ( W/m2 )',fontsize=16)
...
plt.text(2029,8,str(K)+' CMIP5 models',size=16,rotation=0.,
        ha="center",va="center",
...
TEMP1=TAS1[:,0,0]-RefTemp
TEMP2=TAS2[:,0,0]-RefTemp
TEMP3=TAS3[:,0,0]-RefTemp
