...
plt.title("SWIO Surface Tempereture Changes simulated by GCMs and RegCM",fontsize=18)
...
TEMP1=TAS1[:,0,0] - AbsTemp - RefTemp
TEMP2=TAS2[:,0,0] - AbsTemp - RefTemp
TEMP3=TAS3[:,0,0] - AbsTemp - RefTemp
