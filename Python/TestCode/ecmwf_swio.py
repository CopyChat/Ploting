...
time=["00","06","12","18"]
year=["1981"]
#year=["1979","1981","1982","1983","1984"]
param=["131.128","132.128","157.128"]
#param=["129.128","130.128","131.128","132.128","157.128"]
nam=["uwnd","vwnd","rhum"]
#nam=["hgt","air","uwnd","vwnd","rhum"]
	...
	for p in range(len(param)):
		for t in time:
			...
			server.retrieve({
				...
				'grid'    : "0.75/0.75",   	# Two values: West-East/North-South increments
				'format'  : "netcdf",       # if grib, just comment this line 
				'target'  : nam[p]+"."+y+"."+t+".nc"
							})

os.system('alert Work Done ^_^')
