...
*** sumer 2001-2005
ICTP='/Users/tang/climate/Modeling/333/IMPROVEMENT'
Forcing.1='Had_hist'
...
****** BEGIN read the OBS data 
    if(OBSproj.j='ERA_Interim')
      if(OBSvar.j='t2m')
        'sdfopen /Users/tang/climate/GLOBALDATA/OBSDATA/ERA_Interim/ERA.t2m.mon.mean.1996-2005.timmean.nc'
      else
        'sdfopen /Users/tang/climate/GLOBALDATA/OBSDATA/ERA_Interim/ERA.tp.timmean.mean.2001-2005.'monthlab'.nc'
      endif
    endif
    if(OBSproj.j='GPCP')
      'sdfopen /Users/tang/climate/GLOBALDATA/OBSDATA/GPCP/precip.mon.mean.1996-2005.timmean.nc'
    endif
...
*      'sdfopen /Users/tang/climate/GLOBALDATA/OBSDATA/CERES/CERES_EBAF-TOA_Ed2.8_Subset.timmean.2001-2005.nc'
      'sdfopen /Users/tang/climate/GLOBALDATA/OBSDATA/CERES/rsds_CERES-EBAF_L3B_Ed2-8_200101-200112.timmean.nc'
    endif
    if(OBSproj.j='TRMM')
    ...
    if(OBSproj.j='MODIS')
      'sdfopen /Users/tang/climate/GLOBALDATA/OBSDATA/MODIS/clt_MODIS_L3_C5_.timmean.2001-2005.nc'
    endif
    'set dfile 1'
...
*    say 'open 'ICTP'/'ictpfname.k'.'RegCMtag.j'.timmean.2001-2005.nc.ctl'
    say 'sdfopen 'ICTP'/'GCM'/'Forcevar.j'_Amon_'GCM'_historical_r1i1p1_199601-200512.timmean.swio.nc' 
*                     rsds_Amon_GFDL-ESM2M_historical_r1i1p1_199601-200512.timmean.nc
    'sdfopen 'ICTP'/'GCM'/'Forcevar.j'_Amon_'GCM'_historical_r1i1p1_199601-200512.timmean.swio.nc' 
    'set dfile 1'
    'q file'
...
* Interplation GCM data to 'OBSproj' GRID
    ...
    'define biasForcevar=(Fvarrmp-obsvar)'
...
*=================================================== read RegCM data:
*    say 'open 'ICTP'/'ictpfname.k'.'RegCMtag.j'.timmean.2001-2005.nc.ctl'
    say 'open 'ICTP'/'GCM'/'Forcing.1'.'RegCMtag.j'.timmean.1996-2005.nc.ctl'
*                               GFDL_hist.RAD.timmean.1996-2005.nc 
    'open 'ICTP'/'GCM'/'Forcing.1'.'RegCMtag.j'.timmean.1996-2005.swio.nc.ctl'
    'set dfile 1'
    'q file'
...
* Interplation GCM data to 'OBSproj' GRID
    ...
    'define biasRCMvar=(modvarrmp-obsvar)'
*    'quit'
