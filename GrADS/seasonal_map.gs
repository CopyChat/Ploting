...
*** sumer 2001-2005
ICTP='/Users/tang/climate/Modeling/333/Had.G71E0001/output/pprcmdata/seasonal'
ictp.1='GFDL_hist'
...
****** BEGIN read the OBS data 
    ...
    if(OBSproj.j='GHCN')
      'sdfopen /Users/tang/climate/GLOBALDATA/OBSDATA/GHCN/GHCN.air.ymon.mean.2001-2005.'monthlab'.nc'
    endif
    if(OBSproj.j='CMAP')
      'sdfopen /Users/tang/climate/GLOBALDATA/OBSDATA/CMAP/CMAP.precip.ymon.mean.1996-2005.'monthlab'.nc'
    endif
...
*************** read Model data
  k=1
    say 'open 'ICTP'/'ictpfname.k'.'RegCMtag.j'.ymon.mean.1996-2005.'monthlab'.nc.ctl'
    'open 'ICTP'/'ictpfname.k'.'RegCMtag.j'.ymon.mean.1996-2005.'monthlab'.nc.ctl'
    'set dfile 1'
    'q file'
