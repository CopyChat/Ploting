...
* input file name
ictpfname.1='MPI_hist'
ictpfname.2='MPI_hist'
...
****** BEGIN read the OBS data 
    if(OBSproj.j='ERA_Interim')
      if(OBSvar.j='t2m')
        'sdfopen /Users/ctang/climate/GLOBALDATA/OBSDATA/ERA_Interim/ERA.t2m.ymon.mean.2001-2002.'monthlab'.nc'
      else
        'sdfopen /Users/ctang/climate/GLOBALDATA/OBSDATA/ERA_Interim/ERA.tp.ymon.mean.2001-2002.'monthlab'.nc'
      endif
    endif
    if(OBSproj.j='GPCP')
      'sdfopen /Users/ctang/climate/GLOBALDATA/OBSDATA/GPCP/precip.ymon.mean.2001-2002.'monthlab'.nc'
    endif
    if(OBSproj.j='CERES')
      'sdfopen /Users/ctang/climate/GLOBALDATA/OBSDATA/CERES/CERES_EBAF-Surface_Ed2.7_Subset.ymon.mean.2001-2002.'monthlab'.nc'
    endif
    if(OBSproj.j='TRMM')
      'sdfopen /Users/ctang/climate/GLOBALDATA/OBSDATA/TRMM/TRMM.hrf.ymon.mean.2001-2002.'monthlab'.nc'
    endif
    if(OBSproj.j='CRU')
      'sdfopen /Users/ctang/climate/GLOBALDATA/OBSDATA/CRU/3.20/cru_ts3.20.tmp.ymon.mean.2001-2002.'monthlab'.nc'
      say 'sdfopen /Users/ctang/climate/GLOBALDATA/OBSDATA/CRU/3.20/cru_ts3.20.tmp.ymon.mean.2001-2002.'monthlab'.nc'
    endif
    if(OBSproj.j='MODIS')
      'sdfopen /Users/ctang/climate/GLOBALDATA/OBSDATA/MODIS/clt/clt_MODIS_L3_C5_200101-200212.ymonmean.'monthlab'.nc'
    endif
    'set dfile 1'
...
*************** read Model data
  k=1
    say 'open 'ICTP'/'ictpfname.k'.'RegCMtag.j'.ymon.mean.2001-2002.'monthlab'.nc.ctl'
    'open 'ICTP'/'ictpfname.k'.'RegCMtag.j'.ymon.mean.2001-2002.'monthlab'.nc.ctl'
    'set dfile 1'
    'q file'
