...
plt.ylabel('Surface temperature Change (deg)',fontsize=16)
plt.title("Surface temperature Change (deg) in SWIO simulated by CMIP5 models",fontsize=18)
plt.ylim(-2,5)
plt.xlim(1980,2100)
plt.grid()
...
#define the K-th model input file:
    K=K+1 # for average 
    infile1=DIR+'/'\
            +VARIABLE+'_'+PRODUCT+'_'+Model+'_'+EXPERIMENT+'_r1i1p1'+'_'+TIME+'.swio.nc'
...
plt.text(2020,4,str(K)+' models',size=16,rotation=0.,
        ha="center",va="center",
